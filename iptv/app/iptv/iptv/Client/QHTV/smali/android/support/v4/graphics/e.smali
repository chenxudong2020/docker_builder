...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-object v3, Landroid/support/v4/graphics/e;->b:Ljava/lang/reflect/Constructor;

    sput-object v4, Landroid/support/v4/graphics/e;->a:Ljava/lang/Class;

    sput-object v2, Landroid/support/v4/graphics/e;->c:Ljava/lang/reflect/Method;

    sput-object v0, Landroid/support/v4/graphics/e;->d:Ljava/lang/reflect/Method;
...
.method private static a(Ljava/lang/Object;)Landroid/graphics/Typeface;
    ...
    sget-object v1, Landroid/support/v4/graphics/e;->d:Ljava/lang/reflect/Method;
...
.method public a(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/c/b$b;I)Landroid/graphics/Typeface;
    ...
    invoke-direct {v3}, Landroid/support/v4/e/n;-><init>()V
    ...
    invoke-virtual {v3, v6}, Landroid/support/v4/e/n;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p1, p2, v6}, Landroid/support/v4/graphics/i;->a(Landroid/content/Context;Landroid/os/CancellationSignal;Landroid/net/Uri;)Ljava/nio/ByteBuffer;

    move-result-object v0

    invoke-virtual {v3, v6, v0}, Landroid/support/v4/e/n;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v2, v0, v6, v7, v5}, Landroid/support/v4/graphics/e;->a(Ljava/lang/Object;Ljava/nio/ByteBuffer;IIZ)Z
    ...
    :cond_2
    invoke-static {v2}, Landroid/support/v4/graphics/e;->a(Ljava/lang/Object;)Landroid/graphics/Typeface;
...
.method public a(Landroid/content/Context;Landroid/support/v4/content/a/c$b;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v5}, Landroid/support/v4/content/a/c$c;->f()I

    move-result v6

    invoke-static {p1, p3, v6}, Landroid/support/v4/graphics/i;->a(Landroid/content/Context;Landroid/content/res/Resources;I)Ljava/nio/ByteBuffer;
    ...
    :cond_1
    invoke-virtual {v5}, Landroid/support/v4/content/a/c$c;->e()I

    move-result v7

    invoke-virtual {v5}, Landroid/support/v4/content/a/c$c;->b()I

    move-result v8

    invoke-virtual {v5}, Landroid/support/v4/content/a/c$c;->c()Z

    move-result v5

    invoke-static {v2, v6, v7, v8, v5}, Landroid/support/v4/graphics/e;->a(Ljava/lang/Object;Ljava/nio/ByteBuffer;IIZ)Z
