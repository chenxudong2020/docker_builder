...
.method private f()V
    ...
    iget-object v4, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->b:Landroid/support/v7/view/menu/h;

    invoke-virtual {v4}, Landroid/support/v7/view/menu/h;->m()Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/view/menu/h;->getContentDescription()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0}, Landroid/support/v7/view/menu/h;->getTooltipText()Ljava/lang/CharSequence;
    ...
    :goto_4
    invoke-static {p0, v3}, Landroid/support/v7/widget/ax;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public a(Landroid/support/v7/view/menu/h;I)V
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->g:Landroid/support/v7/widget/z;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->g:Landroid/support/v7/widget/z;
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->c:Landroid/support/v7/view/menu/g$b;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->c:Landroid/support/v7/view/menu/g$b;

    iget-object v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->b:Landroid/support/v7/view/menu/h;

    invoke-interface {v0, v1}, Landroid/support/v7/view/menu/g$b;->a(Landroid/support/v7/view/menu/h;)Z
...
.method protected onMeasure(II)V
    ...
    invoke-super {p0, v0, v2, v3, v4}, Landroid/support/v7/widget/q;->setPadding(IIII)V
    ...
    invoke-super {p0, v0, p2}, Landroid/support/v7/widget/q;->onMeasure(II)V
    ...
    invoke-super {p0, v0, v1, v2, v3}, Landroid/support/v7/widget/q;->setPadding(IIII)V
