...
.field private n:Landroid/support/v7/widget/ae;
...
.method a(I)V
    ...
    :goto_2
    invoke-virtual {p0}, Landroid/support/v7/widget/ActivityChooserView;->getListPopupWindow()Landroid/support/v7/widget/ae;

    move-result-object v3

    invoke-virtual {v3}, Landroid/support/v7/widget/ae;->d()Z
    ...
    invoke-virtual {v3, v0}, Landroid/support/v7/widget/ae;->g(I)V

    invoke-virtual {v3}, Landroid/support/v7/widget/ae;->a()V
    ...
    :cond_2
    invoke-virtual {v3}, Landroid/support/v7/widget/ae;->e()Landroid/widget/ListView;
...
.method getListPopupWindow()Landroid/support/v7/widget/ae;
    .locals 2

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/ae;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/ae;
    ...
    invoke-virtual {v0, p0}, Landroid/support/v7/widget/ae;->b(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ae;->a(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/ae;

    iget-object v1, p0, Landroid/support/v7/widget/ActivityChooserView;->i:Landroid/support/v7/widget/ActivityChooserView$b;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ae;->a(Landroid/widget/PopupWindow$OnDismissListener;)V
