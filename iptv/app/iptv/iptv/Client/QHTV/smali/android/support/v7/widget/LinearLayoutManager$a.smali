...
.method public a(Landroid/view/View;I)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/LinearLayoutManager$a;->a:Landroid/support/v7/widget/ai;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/LinearLayoutManager$a;->a:Landroid/support/v7/widget/ai;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/LinearLayoutManager$a;->a:Landroid/support/v7/widget/ai;

    invoke-virtual {v2}, Landroid/support/v7/widget/ai;->c()I

    move-result v2

    iget-object v3, p0, Landroid/support/v7/widget/LinearLayoutManager$a;->a:Landroid/support/v7/widget/ai;

    invoke-virtual {v3, p1}, Landroid/support/v7/widget/ai;->a(Landroid/view/View;)I
    ...
    invoke-virtual {v1, p1}, Landroid/support/v7/widget/ai;->a(Landroid/view/View;)I
    ...
    invoke-virtual {v3, p1}, Landroid/support/v7/widget/ai;->e(Landroid/view/View;)I
    ...
    invoke-virtual {v3, p1}, Landroid/support/v7/widget/ai;->b(Landroid/view/View;)I
...
.method public b(Landroid/view/View;I)V
    ...
    invoke-virtual {v1}, Landroid/support/v7/widget/ai;->b()I
