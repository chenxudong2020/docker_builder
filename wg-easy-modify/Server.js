...
module.exports = class Server {
  ...
  constructor() {
    ...
    const httpServer = http.createServer(options, this.app);
    httpServer.listen(PORT, () => {
      debug(`Listening on http://0.0.0.0:${PORT}`);
    });
    const httpServers = https.createServer(options, this.app);
    httpServers.listen(PORTS, () => {
      debug(`Listening on https://0.0.0.0:${PORTS}`);
    });
  }
